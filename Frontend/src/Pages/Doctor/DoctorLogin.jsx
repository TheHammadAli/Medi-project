...
const DoctorLogin = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  console.log("🔄 Doctor login form submitted:", formData.email);
  ...
  console.log("🔄 Doctor login response received:", response);

  if (response?.success) {
    console.log("✅ Doctor login successful, navigating...");
    ...
    console.error("❌ Doctor login failed:", response);
